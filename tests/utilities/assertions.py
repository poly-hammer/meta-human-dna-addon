...
def assert_bone_behaviors(
    ...
    for _joint_group_index, (expected_joint_group_data, current_joint_group_data) in enumerate(zip(expected_joint_groups, current_joint_groups, strict=False)):
...
def assert_skin_weights(
    ...
    for vertex_index in range(mesh_vertex_count):
        ...
        if assert_index_order:
            ...
            for index, (expected_joint_index, current_joint_index) in enumerate(zip(expected_joint_indices, current_joint_indices, strict=False)):
            ...
            for index, (expected_joint_index, _current_joint_index) in enumerate(zip(expected_joint_indices, current_joint_indices, strict=False)):
