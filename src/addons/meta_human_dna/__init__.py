...
classes = [
    ...
    view_3d.META_HUMAN_DNA_PT_rbf_editor,
    view_3d.META_HUMAN_DNA_PT_rbf_editor_solver_settings_sub_panel,
    view_3d.META_HUMAN_DNA_PT_rbf_editor_poses_sub_panel,
    view_3d.META_HUMAN_DNA_PT_rbf_editor_drivers_sub_panel,
    view_3d.META_HUMAN_DNA_PT_rbf_editor_driven_sub_panel,
    view_3d.META_HUMAN_DNA_PT_rbf_editor_footer_sub_panel,
